...
from bananavoice.db.utils import create_database, drop_database
...
from bananavoice.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from bananavoice.db.models import load_all_models
